...
public class Vehicule_ParChoc : MonoBehaviour
{
    ...
    [SerializeField] private Vector3 _ReactorPosition = new Vector3(0,15f,0); //Position initial du reacteur
    ...
    private Transform _SpringTransform = null; //Contient le transform du spring
    ...
    private void SpawnParChoc() 
    {
        ...
        _SpringTransform = currentSpringPrefab.GetChild(1);
        _SpringTransform.parent = transform;
        _SpringTransform.localPosition = _SpringLocalPosition;
